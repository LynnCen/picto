...
export interface IconshapecircleProps extends React.SVGProps<SVGSVGElement> {}

/**
 * shape_circle
 * @source figma
 */
export const Iconshapecircle = React.memo((props: IconshapecircleProps) => {
  return (
    <svg
...
Iconshapecircle.displayName = 'Iconshapecircle'

export default Iconshapecircle
