...
export interface IconaddcircleProps extends React.SVGProps<SVGSVGElement> {}

/**
 * add_circle
 * @source figma
 */
export const Iconaddcircle = React.memo((props: IconaddcircleProps) => {
  return (
    <svg
    ...
    >
      <path
        d="M11.25 16.2426V12.75H7.75736V11.25H11.25L11.25 7.75735H12.75L12.75 11.25H16.2426V12.75H12.75L12.75 16.2426H11.25Z"
        fill="#222529"
      />
      <path
        fillRule="evenodd"
