...
export interface IconagentstaticProps extends React.SVGProps<SVGSVGElement> {}

/**
 * agent_static
 * @source figma
 */
export const Iconagentstatic = React.memo((props: IconagentstaticProps) => {
  return (
    <svg
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_17652_4785)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_17652_4785"
          x1="2"
          y1="7"
          x2="22"
          y2="17"
        ...
        >
          <stop offset="0.480769" stopColor="#4BDAF7" />
          <stop offset="1" stopColor="#EAA7FF" />
        </linearGradient>
      </defs>
    </svg>
  )
...
Iconagentstatic.displayName = 'Iconagentstatic'

export default Iconagentstatic
