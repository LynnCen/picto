...
export interface IconinspirationfilledProps extends React.SVGProps<SVGSVGElement> {}

/**
 * inspiration_filled
 * @source figma
 */
export const Iconinspirationfilled = React.memo((props: IconinspirationfilledProps) => {
  return (
    <svg
...
Iconinspirationfilled.displayName = 'Iconinspirationfilled'

export default Iconinspirationfilled
