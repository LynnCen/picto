...
export interface IconshaperectangleProps extends React.SVGProps<SVGSVGElement> {}

/**
 * shape_rectangle
 * @source figma
 */
export const Iconshaperectangle = React.memo((props: IconshaperectangleProps) => {
  return (
    <svg
...
Iconshaperectangle.displayName = 'Iconshaperectangle'

export default Iconshaperectangle
