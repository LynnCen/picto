...
export interface IconpagenavleftmultipleProps extends React.SVGProps<SVGSVGElement> {}

/**
 * pagenav_left_multiple
 * @source figma
 */
export const Iconpagenavleftmultiple = React.memo((props: IconpagenavleftmultipleProps) => {
  return (
    <svg
...
Iconpagenavleftmultiple.displayName = 'Iconpagenavleftmultiple'

export default Iconpagenavleftmultiple
