...
export interface IcontemplatefillProps extends React.SVGProps<SVGSVGElement> {}

/**
 * template_fill
 * @source figma
 */
export const Icontemplatefill = React.memo((props: IcontemplatefillProps) => {
  return (
    <svg
...
Icontemplatefill.displayName = 'Icontemplatefill'
