...
export interface IconclosestaticProps extends React.SVGProps<SVGSVGElement> {}

/**
 * close_static
 * @source figma
 */
export const Iconclosestatic = React.memo((props: IconclosestaticProps) => {
  return (
    <svg
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_17162_4394)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#paint1_linear_17162_4394)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_17162_4394"
          x1="2.25"
          y1="12"
          x2="21.75"
          y2="12"
...
Iconclosestatic.displayName = 'Iconclosestatic'

export default Iconclosestatic
