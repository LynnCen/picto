...
export interface IconbatchtempletProps extends React.SVGProps<SVGSVGElement> {}

/**
 * batch_templet
 * @source figma
 */
export const Iconbatchtemplet = React.memo((props: IconbatchtempletProps) => {
  return (
    <svg
    ...
    >
      <path
        ...
        fill="#222529"
      />
      <path d="M5 12H11.5V13.5H5V12Z" fill="#222529" />
      <path d="M9 16H5V17.5H9V16Z" fill="#222529" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
Iconbatchtemplet.displayName = 'Iconbatchtemplet'

export default Iconbatchtemplet
